...
class PortfolioReportService:
    ...
    def _build_breakdown(
        ...
        *,
        ...
        return sorted(
            [
                BreakdownRow(label=label, value=value, share=float(value / total))
    ...
    def _build_header(self, report: PortfolioExecutiveReport) -> Table:
        heading = Paragraph("CarteiraConsol Executive Portfolio Report", self.styles["hero_title"])
        subtitle = Paragraph(
        ...
        body = Paragraph(
            "A premium portfolio summary built directly from the consolidated production dataset, ready for client presentations and executive portfolio reviews.",
    ...
    def _draw_footer(self, canvas, document) -> None:
        ...
        canvas.drawString(16 * mm, 8 * mm, "CarteiraConsol • Executive portfolio report")
